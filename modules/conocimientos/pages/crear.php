...
if ($_POST && isset($_POST['guardar_conocimiento'])) {
    if (isset($_POST['csrf_token']) && verify_csrf_token($_POST['csrf_token'])) {
        try {
            ...
            // Insertar conocimiento (el trigger generará el número automáticamente)
            ...
            // Obtener el número de conocimiento generado
...
exit();
            ...
            if ($conn->inTransaction()) {
                $conn->rollBack();
                debug_log("Transacción revertida debido a un error: " . $e->getMessage(), "ERROR");
            }
        ...
        debug_log("Error de validación CSRF en el bloque POST.", "WARNING");
