...
<head>
    ...
    <title>Conocimientos - Sistema de Entrega de Insumos</title>
                    ...
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                ...
                                <a href="nuevo_conocimiento.php" class="btn btn-primary">
                            ...
                            <form method="GET" action="">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-2 d-flex align-items-end">
                                        ...
                                        <a href="conocimientos.php" class="btn btn-outline-secondary">
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <?php if ($conocimiento['estado'] == 'borrador' && 
                                                            ...
                                                            <a href="editar_conocimiento.php?id=<?php echo $conocimiento['id']; ?>" 
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#detalleModal').on('show.bs.modal', function (event) {
                ...
                var modalBody = $(this).find('#detalleModalBody');
